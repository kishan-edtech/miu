  ...
  <div class="page-content-wrapper ">
    ...
    <div class="content ">
      ...
      <div class=" container-fluid">
        ...
        <div class="row">
          <div class="col-md-12">
            <?php if (!empty($_SESSION['Enrollment_No']) && !empty($_SESSION['ID_Card'])) { ?>
              <iframe src="/app/i-cards/<?= $_SESSION['university_id'] ?>/?id=<?= base64_encode($_SESSION['ID'] . 'W1Ebt1IhGN3ZOLplom9I') ?>" frameborder=0 width="100%" height="900px"></iframe>
            <?php } else { ?>
              <center>
                <h1>Document Under Verification</h1>
              </center>
            <?php } ?>
          </div>
        </div>
