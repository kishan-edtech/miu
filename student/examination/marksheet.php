            ...
            <div class="mt-5 body"
                ...
                <div class="main-result-box" style="padding: 0px; height: 0px; margin: 0 auto; position: relative; top: 0px; right: 0px;">
                   ...
                   <div class="d-flex w-100 justify-content-center">
                    <p class="text-center text-dark fw-bold" style="width:70%; word-wrap:break-word;"> <?= ucwords(strtolower($row['duration_val'] )) ?>  <?=  $course ?></p>
                   </div>
               ...
               <script type="text/javascript">
                $(document).ready(function () {
                    $("#year_semester").change(function () {
                        ...
                        window.location.href = '/ams/student/examination/results?year_sem=' + year_sem;
                    });
                });
            </script>
        <?php } else { ?>
            <script type="text/javascript">
                $("#year_semester").change(function () {
                    ...
                    $.ajax({
                        ...
                        url: '/ams/student/examination/get-sem-data.php',
                        method: 'POST',
                        data: {
                            year_sem: year_sem,
                            user_id: user_id,
