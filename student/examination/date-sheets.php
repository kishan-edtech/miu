              ...
              <div class="table-responsive">
                <table class="table table-striped">
                  ...
                  <tbody>
                      ...
                      <!--    <td><a class="btn btn-primary" href="https://s-voc.maya.edu.in/ams/student/examination/portal" data-toggle="tooltip" data-placement="top" title="Button will be enable before 15 mins of exam schedule.">Start</a></td>-->
                      <!--  </tr>-->
                    <?php 
                      while($date_sheet = $date_sheets->fetch_assoc()){ ?>
                        <tr>
                          ...
                          <td><a class="btn btn-primary" href="https://mdu.exam-portal.in/" data-toggle="tooltip" data-placement="top" title="Button will be enable before 15 mins of exam schedule.">Start</a></td>
                        </tr>  
                    <?php } ?>
                  </tbody>
                </table>
