      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
          ...
          <div class=" container-fluid container-fixed-lg" id="main-content">
                  ...
                  <div class="d-flex justify-content-center mb-3">
                    <div class="card">
                      <div class="card-body text-center">
                        <h5 class="semi-bold">Please add <a href="/academics/universities"><span class="text-primary"><u>Vertical</u></span></a></h5>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <h5 class="semi-bold col-md-12">CRM Settings</h5>
              <div class="col-md-12">
...
<script>
  ...
  function getComponents(id){
    $.ajax({
      url: BASE_URL + '/app/components/main?id='+id,
      type: "GET",
  ...
  function destroyComponents(url, table, id){
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: BASE_URL + "/app/components/"+url+"/destroy?id="+id,
          type: 'DELETE',
          dataType: 'json',
          success: function(data) {
            if(data.status==200){
