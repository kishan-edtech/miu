...
$paymentData = $conn->query("select * from University_Payments where id=".$id)->fetch_assoc();
?>
...
<div class="modal-header clearfix text-left mb-4">
  ...
  <form action="/ams/university/payment/update" method="post" id="unversity_payment_form">
