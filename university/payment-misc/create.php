                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" value="<?php echo $record['First_Name'] . ' ' . $record['Middle_Name'] . ' ' . $record['Last_Name'] ?>" readonly>
                            </div>

                            <div class="col-md-4">
                                <label>Course</label>
                                <input type="text" class="form-control" value="<?php echo $record['Name'] ?>" readonly>
                            </div>
                ...
                <div class="card card-default">
                    <div class="card-body">
                        ...
                        $getMisUniFee = $conn->query("
                            ...
                            AND ucfh.University_ID = $universityId
                        ");
                        ...
                        <div class="mb-3">
                            ...
                            if ($total_paid_mis_uni_fee  < $total_mis_uni_fee) {
                                ...
                                <div class="row pull-right">
                                    <div class="col-md-2">
                                        <button class="btn btn-primary"
                                            onclick="addUniversityPayment(<?= $id ?>,<?= $record['ID'] ?>,1)">Add Payment</button>
                                    </div>
                                </div>
                                <?php
                            }
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $universityPaidAmountQuery = "select * from University_Payments_Misc where student_id=" . $id . "";
                                    $paidAmountData            = $conn->query($universityPaidAmountQuery);
                                    $amount                    = 0;
                                    $i                         = 1;
                                    while ($row = $paidAmountData->fetch_assoc()) {
