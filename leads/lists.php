  ...
  <div class="page-content-wrapper ">
        ...
        <div class=" container-fluid sm-p-l-0 sm-p-r-0">
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div class="text-end">
                <a href="/leads/generate"><span class="text-muted bold"> Add</sapn></a>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
          </div>
    ...
    <script>
      ...
      function getStageCount(value, name, search) {
        $.ajax({
          url: BASE_URL + '/app/leads/stage_count?id=' + value + '&search=' + search,
          type: 'GET',
      ...
      function getAllCount() {
        $.ajax({
          url: BASE_URL + '/app/leads/stage_count',
          type: 'GET',
          success: function(data) {
            $('#allLeads').html(data);
          }
      ...
      function getOwnCount() {
        $.ajax({
          url: BASE_URL + '/app/leads/stage_count?user=' + <?= $_SESSION['ID'] ?>,
          type: 'GET',
          success: function(data) {
            $('#ownLeads').html(data);
          }
    ...
    <script type="text/javascript">
      function changeStage(stage) {
        ...
        $.ajax({
          url: BASE_URL + '/app/leads/update_stage',
          type: 'post',
          data: {
            "stage": stage
          },
    ...
    <script type="text/javascript">
      function addFollowUp(id, name, university_id) {
        $.ajax({
          url: BASE_URL + '/app/follow-ups/create',
          type: 'post',
          data: {
            "id": id,
            "name": name,
    ...
    <script type="text/javascript">
      function multipleRefer() {
        ...
        if (ids.length > 1) {
          $.ajax({
            url: BASE_URL + '/app/refer/create_multiple',
            type: 'post',
            data: {
              "ids": ids
            },
    ...
    <script type="text/javascript">
      function updateStudentID(id) {
        $.ajax({
          url: BASE_URL + '/app/leads/student-id/create?id=' + id,
          type: 'GET',
          success: function(data) {
            $('#md-modal-content').html(data);
            $('#mdmodal').modal('show');
