  ...
  <div class="page-content-wrapper ">
              ...
              <div class="row row-same-height">
                ...
                <div class="col-md-8">
                  <div class="padding-10 sm-padding-5">
                    <form id="step_1" role="form" autocomplete="off" action="/ams/app/exam-students/store-exam-student" enctype="multipart/form-data">
                      <h5>Applying For</h5>
    ...
    <script type="text/javascript">
      ...
      function getEligibility(){
        const sub_course_id = $('#sub_course').val();
        $.ajax({
          url: BASE_URL + '/app/application-form/course-eligibility?id='+sub_course_id,
          type:'GET',
          dataType: 'json',
          success: function(data) {
            if(data.status){
