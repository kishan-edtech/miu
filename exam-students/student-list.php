  ...
  <div class="page-content-wrapper ">
    ...
    <script type="text/javascript">
      $(function() {
        ...
        var applicationSettings = {
          ...
          'serverMethod': 'post',
          'ajax': {
            'url': BASE_URL + '/app/exam-students/server',
            'type': 'POST',
    ...
    <script type="text/javascript">
      ...
      function exportSelectedDocument() {
        ...
        $.ajax({
          url: BASE_URL + '/app/applications/documents/create' + searchQuery,
          type: 'GET',
          success: function(data) {
            $('#md-modal-content').html(data);
            $('#mdmodal').modal('show');
    ...
    <script type="text/javascript">
      ...
      function uploadMultiplePendency() {
        $(".modal").modal('hide');
        $.ajax({
          url: BASE_URL + '/app/pendencies/upload',
          type: 'GET',
          success: function(data) {
            $("#lg-modal-content").html(data);
            $("#lgmodal").modal('show');
    ...
    <script>
      ...
      function getCourses(id) {
        $.ajax({
          url: BASE_URL + '/app/courses/department-courses',
          type: 'POST',
          data: {
            id
          },
