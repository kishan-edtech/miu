          ...
          <div class="card-body">
            <div class="card card-transparent">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle" data-init-reponsive-tabs="dropdownfx">
                ...
                <li class="nav-item">
                  <a data-toggle="tab" data-target="#not_processed" href="#"><span>New - <span
                        id="not_processed_count">0</span></span></a>
                </li>
                <li class="nav-item">
                  <a data-toggle="tab" data-target="#ready_for_verification" href="#"><span>Fee Received - <span
                        id="ready_for_verification_count">0</span></span></a>
                </li>
                <li class="nav-item">
                  <a data-toggle="tab" data-target="#verified" href="#"><span>Ready for Enrollment - <span
