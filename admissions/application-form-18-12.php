    ...
    <div class="content ">
      ...
      if (isset($_GET['lead_id']) && $_SESSION['Role'] != 'Student') {
        ...
        if ($lead->num_rows > 0) {
          ...
          echo '<script type="text/javascript">window.location.href="/leads/lists"</script>';
        }
                      ...
                      <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                          <div class="form-group form-group-default required">
                            <label>Center</label>
                            <select class="full-width" style="border: transparent;" data-init-plugin="select2" name="center" id="center" onchange="getCourse()">
                    ...
                    <div class="padding-10 sm-padding-5">
                      ...
                      <div class="row clearfix">
                        <div class="col-md-6">
                          <div class="form-group form-group-default required">
                            <label>Mobile</label>
                            <input type="tel" name="contact" <?php echo $_SESSION['crm'] ? 'disabled' : '' ?> onkeypress="return isNumberKey(event);" maxlength="10" value="<?php print !empty($id) && !empty($student['Contact']) ? $student['Contact'] : (!empty($lead_id) ? $lead['Mobile'] : '') ?>" class="form-control" placeholder="ex: 9977886655">
                          </div>
                        </div>
