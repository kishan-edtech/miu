          ...
          <div class="inner">
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div>
               ...
               <button class="btn border-0 p-2 add_btn_form"  data-toggle="tooltip" data-original-title="Download Bulk Certificate" onclick="add_bulk('certificates','lg')"> <i class="uil uil-download-circle\"></i>Download Bulk Certificate</button>
               <button class="btn border-0 p-2 add_btn_form"  data-toggle="tooltip" data-original-title="Add" onclick="add('certificates','lg')"> <i class="ti ti-copy-plus "></i>Add</button
              </div>
            </ol>
          </div>
        </div>
      ...
      BASE_URL = "<?= $base_url ?>";
        $(function() {
            ...
            var settings = {
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': '/ams/app/certificates/data-list'
                },
                'columns': [{
                        data: "student_name"
                    },
