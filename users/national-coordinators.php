            ...
            <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
              <div class="inner">
                ...
                <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
                  ...
                  ?>
                  <div class="text-end">
                    <button class="btn btn-link" aria-label="" title="" data-toggle="tooltip" data-original-title="Download National Coordinators" onclick="exportData()"> <i class="ti ti-square-rounded-arrow-down add_btn_form" style="font-size:24px;"></i></button>
                    <button class="btn btn-link" aria-label="" title="" data-toggle="tooltip" data-original-title="Add National Coordinators" onclick="add('sub-counsellors','lg')"> <i class="ti ti-copy-plus add_btn_form" style="font-size:24px;"></i></button>
                  </div>
                </ol>
                <!-- END BREADCRUMB -->
              </div>
...
<script type="text/javascript">
  ...
  $(function(){
      ...
      var settings = {
        ...
        'serverMethod': 'post',
        'ajax': {
          'url': BASE_URL + '/app/sub-counsellors/server'
        },
        'columns': [  
          { data: "Photo",width:"10%",
            "render": function(data, type, row){
              return '<span class="thumbnail-wrapper d48 circular inline">\
      					<img src="/ams'+data+'" alt="" data-src="'+data+'"\
         ...
         .map(item => {
          ...
          { data: "ID",width:"10%",
            "render": function(data, type, row){
                ...
                <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit National Coordinators" onclick="edit(&#39;sub-counsellors&#39;, &#39;'+data+'&#39, &#39;lg&#39;)"></i>\
                <i class="ti ti-trash-x cursor-pointer add_btn_form h5" data-toggle="tooltip" data-placement="top" title="Delete National Coordinators" onclick="destroy(&#39;sub-counsellors&#39;, &#39;'+data+'&#39)"></i>\
              </div>'
                }
              return '<div class="button-list text-end">\
                <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;sub-counsellors&#39;, &#39;'+data+'&#39, &#39;lg&#39;)"></i>\
                <i class="ti ti-trash-x cursor-pointer add_btn_form h5" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;sub-counsellors&#39;, &#39;'+data+'&#39)"></i>\
              </div>'
            }
          },
        ],
...
<script>
  ...
  function allot(id, modal){
    $.ajax({
      url: BASE_URL + '/app/sub-counsellors/allot-university?id='+id,
      type: 'GET',
...
<script type="text/javascript">
  function exportData(){
    ...
    window.open('/ams/app/sub-counsellors/export'+url);
  }
</script>
