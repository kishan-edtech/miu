              ...
              <div class="inner">
                ...
                <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
                  ...
                  <div class="text-end">
                    ...
                    <button class="btn btn-link" aria-label="" title="" data-toggle="tooltip" data-original-title="Add" onclick="add('counsellors','lg')"> <i class="ti ti-copy-plus add_btn_form" style="font-size: 24px;"></i></button>
                  </div>
                </ol>
                <!-- END BREADCRUMB -->
              </div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="table-bordered px-3 py-2">
                      <table class="table table-hover nowrap table-responsive" id="users-table" style="width:100% !important;">
                        <thead>
                          <tr>
...
<script type="text/javascript">
  ...
  $(function(){
    ...
    var settings = {
      ...
      'serverMethod': 'post',
      'ajax': {
        'url': BASE_URL + '/app/counsellors/server'
      },
      'columns': [  
        { data: "Photo",width:"10%",
      ...
      visible: show_to_admin },
        ...
        { data: "ID",width:"10%",
          "render": function(data, type, row){
              if(show_to_admin || role=='Inhouse-Counsellor' || role=="Operations")
              {
              ...
              <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;counsellors&#39;, &#39;'+data+'&#39, &#39;lg&#39;)"></i>\
              <i class="ti ti-trash-x cursor-pointer add_btn_form h5" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;counsellors&#39;, &#39;'+data+'&#39)"></i>\
            </div>'
              }
            return '<div class="button-list text-end">\
              <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;counsellors&#39;, &#39;'+data+'&#39, &#39;lg&#39;)"></i>\
...
<script>
  ...
  function allot(id, modal){
    $.ajax({
      url: BASE_URL + '/app/counsellors/allot-university?id='+id,
      type: 'GET',
...
<script type="text/javascript">
  function exportData(){
    ...
    window.open('/ams/app/counsellors/export'+url);
  }
</script>
