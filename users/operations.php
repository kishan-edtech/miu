            ...
            <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
              <div class="inner">
                ...
                <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
                  ...
                  ?>
                  <div class="text-end">
                    <span class="text-muted bold cursor-pointer" onclick="add('operations','lg')"aria-label="" title="" data-toggle="tooltip" data-original-title="Add Operations" > <i class="ti ti-copy-plus add_btn_form" style="font-size:24px;"></i></sapn>
                  </div>
                </ol>
                <!-- END BREADCRUMB -->
...
<script type="text/javascript">
  ...
  $(function(){
      ...
      var settings = {
        ...
        'serverMethod': 'post',
        'ajax': {
          'url': BASE_URL + '/app/operations/server'
        },
        'columns': [  
          { data: "Photo",width:"10%",
          ...
          { data: "ID",width:"10%",
            "render": function(data, type, row){
              return '<div class="button-list text-end">\
                <i class="ti ti-square-rounded-plus add_btn_form h5 cursor-pointer" aria-label="" title="" data-toggle="tooltip" data-original-title="Allot University"  onclick="allot(&#39;'+data+'&#39, &#39;lg&#39;)"></i>\
                <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer"  aria-label="" title="" data-toggle="tooltip" data-original-title="Edit Operation" onclick="edit(&#39;operations&#39;, &#39;'+data+'&#39, &#39;lg&#39;)"></i>\
                <i class="ti ti-trash-x cursor-pointer add_btn_form h5"  aria-label="" title="" data-toggle="tooltip" data-original-title="Delete Operation" onclick="destroy(&#39;operations&#39;, &#39;'+data+'&#39)"></i>\
              </div>'
            }
          },
        ],
...
<script>
  function allot(id, modal){
    $.ajax({
      url: BASE_URL + '/app/operations/allot-universities?id='+id,
      type: 'GET',
