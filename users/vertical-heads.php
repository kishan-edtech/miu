            ...
            <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
              <div class="inner">
                ...
                <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
                  ...
                  ?>
                  <div class="text-end">
                    <span class="text-muted bold cursor-pointer" aria-label="" title="" data-toggle="tooltip" data-original-title="Add Vertical Head" onclick="add('university-heads','lg')"> <i class="ti ti-copy-plus add_btn_form" style="font-size:24px"></i></sapn>
                  </div>
                </ol>
                <!-- END BREADCRUMB -->
...
<script type="text/javascript">
  ...
  $(function(){
      ...
      var settings = {
        ...
        'serverMethod': 'post',
        'ajax': {
          'url': BASE_URL + '/app/university-heads/server'
        },
        'columns': [  
          { data: "Photo",width:"15%",
          ...
          { data: "ID",width:"15%",
            "render": function(data, type, row){
              return '<div class="button-list text-end">\
                ...
                <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;university-heads&#39;, &#39;'+data+'&#39, &#39;lg&#39;)"></i>\
                <i class="ti ti-trash-x cursor-pointer add_btn_form h5" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;university-heads&#39;, &#39;'+data+'&#39)"></i>\
              </div>'
            }
          },
        ],
...
<script>
  function allot(id, modal){
    $.ajax({
      url: BASE_URL + '/app/university-heads/allot-universities?id='+id,
      type: 'GET',
