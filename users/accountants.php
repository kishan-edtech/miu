            ...
            <div class=" container-fluid   sm-p-l-0 sm-p-r-0">
              <div class="inner">
                ...
                <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
                  ...
                  ?>
                  <div class="text-end">
                    <span class="text-muted bold cursor-pointer" data-toggle="tooltip" data-placement="top" title="Add Accountant" onclick="add('accountants','lg')"> <i class="ti ti-copy-plus add_btn_form" style="font-size:24px !important;"></i></span>
                  </div>
                </ol>
                <!-- END BREADCRUMB -->
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="table-bordered px-3 py-2">
                      <table class="table table-hover nowrap table-responsive" style="margin-top:0px !important;width:100% !important" id="users-table">
                        <thead>
                          <tr>
...
<script type="text/javascript">
  ...
  $(function(){
      ...
      var settings = {
        ...
        'serverMethod': 'post',
        'ajax': {
          'url': BASE_URL + '/app/accountants/server'
        },
        'columns': [  
          { data: "Photo",width:"10%",
          ...
          { data: "ID",width:"10%",
            "render": function(data, type, row){
              return '<div class="button-list text-end">\
                ...
                <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer" data-toggle="tooltip" data-placement="top" title="Edit" onclick="edit(&#39;accountants&#39;, &#39;'+data+'&#39, &#39;lg&#39;)"></i>\
                <i class="ti ti-trash-x cursor-pointer add_btn_form h5" data-toggle="tooltip" data-placement="top" title="Delete" onclick="destroy(&#39;accountants&#39;, &#39;'+data+'&#39)"></i>\
              </div>'
            }
          },
        ],
...
<script>
  function allot(id, modal){
    $.ajax({
      url: BASE_URL + '/app/accountants/allot-universities?id='+id,
      type: 'GET',
