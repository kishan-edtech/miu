        ...
        <div class=" container-fluid sm-p-l-0 sm-p-r-0">
           <div class="inner">
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              ?>
              <div>
              <button class="btn border-0 shadow-none "  data-toggle="tooltip" data-original-title="Add videos" onclick="add('videos','lg')"> <i class="ti ti-copy-plus add_btn_form" style="font-size:24px !important;"></i></button>
              </div>
            </ol>
        ...
        <div class="card card-transparent">
          ...
          <div class="card-body">
            <div class="table-bordered px-3 py-2">
              <table class="table table-hover nowrap table-responsive" id="video_lectures-table">
                <thead>
                  <tr>
                  <th>Subject</th>
                  <th>Course</th>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var settings = {
                ...
                'serverMethod': 'post',
                'ajax': {
                    'url': BASE_URL + '/app/videos/data-list'
                },
                'columns': [
                    {
                        data: "subject_name",width:"40%"
                    },
                    {
                    ...
                    },
                    {
                      ...
                      "render": function(data, type, row) {
                        ...
                        <i class="ti ti-edit-circle add_btn_form h5 cursor-pointer" onclick="edit(&#39;videos&#39;, &#39;' + data + '&#39, &#39;lg&#39;)"></i>\
                        <i class="ti ti-trash-x cursor-pointer add_btn_form h5" onclick="changeStatus('+"'video_lectures'"+', '+data+','+"'status'"+',2)"></i>\
                      </div>'
                      }
                    },
                ],
