        ...
        $('.show-notification').click(function(e) {
            ...
            if (style == 'Bar') {
                ...
                $('.page-content-wrapper').pgNotification({
                    ...
                    timeout: 0,
                    type: type,
                    thumbnail: '<img width="40" height="40" style="display: inline-block;" src="/ams/assets/img/profiles/avatar2x.jpg" data-src="/ams/assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar2x.jpg" alt="">'
                }).show();
