...
<div class="page-container ">
  ...
  <div class="page-content-wrapper ">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div class="text-end">
                <?php if ($_SESSION['Role'] == 'University Head' || $_SESSION['Role'] == 'Administrator') { ?>
                  <button class="btn btn-link" aria-label="" title="" data-toggle="tooltip" data-original-title="Add" onclick="add('downloads/question-papers', 'md')"> <i class="uil uil-plus-circle"></i></button>
                <?php } ?>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
        ...
        <div class="card card-transparent">
          <div class="card-header">
            <div class="pull-right">
              <div class="col-xs-12">
                <input type="text" id="question-papers-search-table" class="form-control pull-right" placeholder="Search">
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-hover nowrap" id="question-papers-table">
                <thead>
                  <tr>
                    <th>Name</th>
                    <th>University</th>
    ...
    <script type="text/javascript">
      ...
      $(function() {
        var table = $('#question-papers-table');
        ...
        var settings = {
          ...
          'serverMethod': 'post',
          'ajax': {
            'url': BASE_URL + '/app/downloads/question-papers/server'
          },
          'columns': [{
              data: "Name",
            ...
            },
            {
              ...
              <i class="uil uil-trash icon-xs cursor-pointer" title="Delete" onclick="destroy(&#39;downloads/question-papers&#39;,&#39;' + data + '&#39)"></i>\
            </div>'
              }
            },
          ],
        ...
        $('#question-papers-search-table').keyup(function() {
