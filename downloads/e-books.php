            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div class="text-end">
                <?php if ($_SESSION['Role'] == 'University Head' || $_SESSION['Role'] == 'Administrator') { ?>
                  <button class="btn btn-link" aria-label="" title="" data-toggle="tooltip" data-original-title="Add" onclick="add('downloads/e-books', 'md')"> <i class="uil uil-plus-circle"></i></button>
                <?php } ?>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
    ...
    <script type="text/javascript">
      ...
      $(function() {
        ...
        var settings = {
          ...
          'serverMethod': 'post',
          'ajax': {
            'url': BASE_URL + '/app/downloads/e-books/server'
          },
          'columns': [{
              data: "Name",
            ...
            },
            {
              ...
              <i class="uil uil-trash icon-xs cursor-pointer" title="Delete" onclick="destroy(&#39;downloads/e-books&#39;,&#39;' + data + '&#39)"></i>\
            </div>'
              }
            },
          ],
