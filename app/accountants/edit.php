...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Edit <span class="semi-bold">Accountant</span></h5>
</div>
<form role="form" id="form-edit-accountants" action="/ams/app/accountants/update" method="POST" enctype="multipart/form-data">
  <div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group form-group-default required">
          <label>Contact</label>
          <input type="tel" name="contact" class="form-control" minlength="10" maxlength="10" placeholder="ex: 9998777655" onkeypress="return isNumberKey(event)" value="<?=$user['Mobile']?>" required>
        </div>
      </div>
    </div>
...
<script>
  $(function(){
    $('#form-edit-accountants').validate({
      rules: {
        name: {required:true},
        code: {required:true},
        email: {required:true},
  ...
  $("#form-edit-accountants").on("submit", function(e){
    if($('#form-edit-accountants').valid()){
