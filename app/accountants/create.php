...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Add <span class="semi-bold">Accountant</span></h5>
</div>
<form role="form" id="form-add-accountants" action="/ams/app/accountants/store" method="POST" enctype="multipart/form-data">
