...
<form role="form" id="form-upload-question" action="/ams/app/downloads/question-papers/store" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  $("#form-upload-question").on("submit", function(e){
    if($('#form-upload-question').valid()){
      ...
      $.ajax({
          ...
          success: function(data) {
              if(data.status==200){
                ...
                $('#question-papers-table').DataTable().ajax.reload(null, false);
              }else{
