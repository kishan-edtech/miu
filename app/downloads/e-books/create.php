...
<form role="form" id="form-upload-ebook" action="/ams/app/downloads/e-books/store" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  $("#form-upload-ebook").on("submit", function(e){
    if($('#form-upload-ebook').valid()){
      ...
      $.ajax({
          ...
          success: function(data) {
              if(data.status==200){
                ...
                $('#ebooks-table').DataTable().ajax.reload(null, false);
              }else{
