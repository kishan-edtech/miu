...
include '../../includes/helpers.php';
  ...
  if(!empty($center_ids)){
       ...
       $centersql =  "  AND ID IN (".$center_ids.") ";
  ...
  ## Fetch records
  $result_record = "SELECT `ID`, `Name`, `Contact_Name`, `Code`, `Status`, CAST(AES_DECRYPT(Password, '60ZpqkOnqn0UQQ2MYTlJ') AS CHAR(50)) password FROM Users WHERE Role = 'Center' $centersql $center_query $searchQuery $orderby";
