...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Edit <span class="semi-bold"></span>Program</h5>
</div>
<form role="form" id="form-edit-course" action="/ams/app/courses/update" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  function getCourseType(id) {
    $.ajax({
      url: BASE_URL + '/app/courses/course-types?id=' + id,
      type: 'GET',
