<?php
  if(isset($_POST['name']) && isset($_POST['course_type']) && isset($_POST['university_id'])){
    ...
    if(empty($name) || empty($short_name) || empty($course_type) || empty($university_id)){
    ...
    $add = $conn->query("INSERT INTO `Courses`(`Name`, `Short_Name`, `Course_Type_ID`, `University_ID`) VALUES ('$name', '$short_name', $course_type, $university_id)");
    if($add){
