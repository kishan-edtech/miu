...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Add <span class="semi-bold"></span>Program</h5>
</div>
<form role="form" id="form-add-course" action="/ams/app/courses/store" method="POST" enctype="multipart/form-data">
