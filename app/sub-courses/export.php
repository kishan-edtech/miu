<?php
  ...
  $header = array('Course Type', 'Course', 'Specialization', 'Mode', 'University', 'Status');
  
  ## Search 
  $searchQuery = " ";
  if($search_value != ''){
    $searchQuery = " AND (Sub_Courses.Name like '%".$searchValue."%' OR Sub_Courses.Short_Name like '%".$searchValue."%' OR Universities.Short_Name LIKE '%".$searchValue."%' OR Universities.Vertical  like '%".$searchValue."%' OR Modes.Name  like '%".$searchValue."%'  OR Courses.Short_Name  like '%".$searchValue."%' OR Courses.Name  like '%".$searchValue."%')";
  }
