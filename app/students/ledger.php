  ...
  <div class="row">
      ...
      <div class="card card-transparent">
        <div class="card-header bg-transparent text-center">
          <img class="profile_img" src="<?= '/ams'.$student['Location'] ?>" alt="">
              ...
              <tbody>
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td><?= $ledger['Source'] ?></td>
                    <td><a href="/ams/print/receipt/index.php?id=<?= $ledger['ID'] ?>&duration=<?= $ledger['Duration'] ?>" target="_blank"><u>
