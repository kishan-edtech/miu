...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h5 class="font-weight-bold text-black">Update <span class="semi-bold">Vertical</span></h5>
  </div>
  <form role="form" id="form-edit-university" action="/ams/app/universities/update" method="POST" enctype="multipart/form-data">
    <div class="modal-body">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group form-group-default required">
            <label>Vertical Dealing with</label>
     ...
     <div class="row">
        <div class="col-md-6">
          <div class="form-group form-group-default required custom_file_upload">
            <label>Logo</label>
