...
?>
  ...
  <form role="form" id="upload-pendency-form" action="/ams/app/pendencies/update" method="POST" enctype="multipart/form-data">
    <div class="modal-body">
      ...
      if ($pendency->num_rows > 0) {
        ...
        $multiple = array('High_School_Marksheet', 'Intermediate_Marksheet', 'Graduation_Marksheet', 'Post_Graduation_Marksheet', 'Other_Marksheet', 'Affidavit', 'Migration', 'Other_Certificate', 'Aadhar_Front','Aadhar_Back');
