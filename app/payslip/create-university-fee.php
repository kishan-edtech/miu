...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['slip_id'])) {
    ...
    <div class="modal-header clearfix text-left">
        ...
        <h5>Add <span class="semi-bold"></span>University Fee Payment</h5>
    </div>
    <form role="form" id="pay-university-form" action="/ams/app/payslip/pay-university-fee" method="POST"
        enctype="multipart/form-data">
        <input type="hidden" id ="slip_id" name="slip_id" value="<?=$slip_id ?>">
        <input type="hidden" id ="student_ids" name="student_ids" value="<?=$student_ids ?>">
        <input type="hidden" id ="slip_id" name="slip_id" value="<?=$slip_id ?>">
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-group-default required">
                        ...
                        <select class="full-width" style="border: transparent;" onchange="checkFileIsRequred(this.value)"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-group-default required">
                        <label>Amount</label>
                        <input type="number" min="1" value="<?= $uni_fee ?>" readonly name="amount" id="amount"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group form-group-default required">
                        <label>Date</label>
                        <input type="tel" name="transaction_date" class="form-control" placeholder="dd-mm-yyyy"
    ...
    <script>
        ...
        $("#pay-university-form").on("submit", function (e) {
            if ($('#pay-university-form').valid()) {
