...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Edit <span class="semi-bold">Department</span></h5>
</div>
<form role="form" id="form-edit-department" action="/ams/app/departments/update" method="POST" enctype="multipart/form-data">
