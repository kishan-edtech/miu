...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Edit <span class="semi-bold">Academic Head</span></h5>
</div>
<form role="form" id="form-edit-academic-heads" action="/ams/app/academic-heads/update" method="POST" enctype="multipart/form-data">
...
<script>
  $(function() {
    $('#form-edit-academic-heads').validate({
      rules: {
        name: {
          required: true
        },
  ...
  $("#form-edit-academic-heads").on("submit", function(e) {
    if ($('#form-edit-academic-heads').valid()) {
