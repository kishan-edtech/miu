...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h5 class="font-weight-bold text-black">Allot <span class="semi-bold"></span>Universities</h5>
  </div>
  <form role="form" id="form-allot-universities" action="/ams/app/university-heads/allot" method="POST" enctype="multipart/form-data">
