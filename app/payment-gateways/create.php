...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Add <span class="semi-bold">Payment Gateway</span></h5>
</div>
<form id="payment_gateway_form" method="POST" action="/ams/app/payment-gateways/store">
