...
?>
        ...
        <div class="modal-header">
            <h5 class="modal-title font-weight-bold text-bold" id="myModalLabel">Student Assignment Update Result</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <form id="resultForm" action="/ams/app/assignments/update_assignment_result" method="POST" enctype="multipart/form-data">
...
<!-- <script type="text/javascript">
    $(document).ready(function() {
        $('#update').click(function(event) {
            ...
            $.ajax({
                data: $('form').serialize(),
                url: BASE_URL + '/app/assignments/update_assignment_result',
                type: 'POST',
