...
<div class="modal-body">
    <div class="modal-header">
        <h5 class="font-weight-bold text-black">Bulk Downloads Submitted Assignments</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    </div>
    <form id="assignmentForm" method="post" action="/ams/app/zip_bulk_download/create_zip_structure.php" enctype="multipart/form-data">
        <div class="row">
            <div class="col-sm-12">
        ...
        <div class="modal-footer">
            ...
            <!--<button type="submit" name="submit" class="btn btn-primary">Download Assignment</button>-->
            ...
            <i class="ti ti-circle-check mr-2"></i> Download Assignment</button>
        </div>
    </form>
...
<script>
    ...
    function getSpecialization(courseName) {
        $.ajax({
            type: 'POST',
            url: BASE_URL + '/app/zip_bulk_download/get_subcourses',
            data: {
    ...
    function getsemester(subCourseId) {
        $.ajax({
            type: 'POST',
            url: BASE_URL + '/app/zip_bulk_download/getsemester',
            data: {
    ...
    function getSubjects(semester) {
        ...
        $.ajax({
            url: BASE_URL + '/app/zip_bulk_download/getsubject',
            type: 'POST',
            dataType: 'text',
            data: {
                'semester': semester,
