...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Add <span class="semi-bold">Vertical Head</span></h5>
</div>
<form role="form" id="form-add-university-heads" action="/ams/app/university-heads/store" method="POST" enctype="multipart/form-data">
