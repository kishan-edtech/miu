        ...
        <div class="col-md-4 pb-2">
          <div class="form-group form-group-default form-group-default-select2">
            ...
            <select class=" full-width" data-init-plugin="select2" multiple id="user_role_<?=$university['ID']?>" name="user_roles[<?=$university['ID']?>][]" onchange="getUsers('<?=$university['ID']?>');">
              <option value="All">All</option>
              <option value="University Head">Vertical Head</option>
  ...
  <script type="text/javascript">
    function getSubSources(id){
      ...
      value.forEach(function(element) {
        $.ajax({
          url: BASE_URL + '/app/components/select/source_subsources?id='+element,
          type: 'GET',
    ...
    function getStates(id){
      ...
      value.forEach(function(element) {
        $.ajax({
          url: BASE_URL + '/app/components/select/country_states?id='+element,
          type: 'GET',
          success: function(data){
    ...
    function getCities(id){
      ...
      state.forEach(function(element) {
        $.ajax({
          url: BASE_URL + '/app/components/select/state_cities?id='+element,
          type: 'GET',
          success: function(data){
    ...
    function getUsers(id){
      ...
      value.forEach(function(element) {
        $.ajax({
          url: BASE_URL + '/app/components/select/role_users?role='+element+'&university_id='+id,
          type: 'GET',
          success: function(data){
