...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h6 class="font-weight-bold text-black">Update <span class="semi-bold">Last Date for </span></h6>
  </div>
  <form role="form" id="lastDateForm" action="/ams/app/components/exam-sessions/update-last-date" method="POST">
