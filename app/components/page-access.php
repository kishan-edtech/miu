      ...
      <div class="row p-b-20">
        <div class="col-lg-12">
          <div class="table-bordered px-3 py-2">
            <table class="table table-hover nowrap table-responsive" style="margin-top:0px !important;" id="tablePageAccess">
              <thead>
                <tr>
                  <th>Name</th>
...
<script type="text/javascript">
  ...
  var settings = {
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': BASE_URL + '/app/components/page-access/server',
      type: 'POST',
      "data":function(data) {
    ...
    'columns': [  
      ...
      { data: "Inhouse",width:"500px",className:"text-center",
      ...
      { data: "Center",width:"500px",className:"text-center",
        "render": function(data, type, row){
          var active = data==1 ? 'Active' : 'Inactive';
          var checked = data==1 ? 'checked' : '';
          return '<div class="form-check form-check-inline switch switch-lg success">\
      ...
      { data: "Sub_Center",width:"500px",className:"text-center",
        "render": function(data, type, row){
          var active = data==1 ? 'Active' : 'Inactive';
          var checked = data==1 ? 'checked' : '';
          return '<div class="form-check form-check-inline switch switch-lg success">\
      ...
      { data: "Student",width:"500px",className:"text-center",
        "render": function(data, type, row){
          var active = data==1 ? 'Active' : 'Inactive';
          var checked = data==1 ? 'checked' : '';
          return '<div class="form-check form-check-inline switch switch-lg success">\
...
<script type="text/javascript">
  function changeInhouseStatus(id){
    $.ajax({
      url:'/ams/app/components/page-access/inhouse?id='+id+'&university_id=<?=$university_id?>',
      type: 'GET',
      dataType: 'json',
  ...
  function changeSubCenterStatus(id){
    $.ajax({
      url:'/ams/app/components/page-access/sub-center?id='+id+'&university_id=<?=$university_id?>',
      type: 'GET',
      dataType: 'json',
      success: function(data) {
        if(data.status == 200){
  ...
  function changeStudentStatus(id){
    $.ajax({
      url:'/ams/app/components/page-access/student?id='+id+'&university_id=<?=$university_id?>',
      type: 'GET',
      dataType: 'json',
      success: function(data) {
        if(data.status == 200){
