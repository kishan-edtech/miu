<?php
  if(isset($_POST['name']) && isset($_POST['university_id']) && isset($_POST['id']) && isset($_POST['fee_structures'])){
    ...
    $add = $conn->query("UPDATE `Schemes` SET `Name` = '$name', `Fee_Structure` = '".json_encode($fee_structures)."' WHERE ID = $id");
    if($add){
