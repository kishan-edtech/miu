...
<div class="modal-header clearfix text-left">
  ...
  <h6 class="font-weight-bold text-black">Add <span class="semi-bold">Sub-Source</span></h6>
</div>
<form id="sub_sources_form" method="POST" action="/ams/app/components/sub-sources/store">
