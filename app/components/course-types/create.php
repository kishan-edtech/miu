<?php if (isset($_GET['university_id'])) { ?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h6 class="font-weight-bold text-black">Add <span class="semi-bold">Program Type</span></h6>
  </div>
  <form role="form" id="form-add-course-types" action="/ams/app/components/course-types/store" method="POST">
