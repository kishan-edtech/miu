...
?>
    ...
    <div class="modal-header clearfix text-left">
      ...
      <h6 class="font-weight-bold text-black">Edit <span class="semi-bold">Program Type</span></h6>
    </div>
    <form role="form" id="form-edit-course-types" action="/ams/app/components/course-types/update" method="POST">
