<?php if(isset($_GET['university_id'])){ ?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h6 class="font-weight-bold text-black">Add <span class="semi-bold">Admission Type</span></h6>
  </div>
  <form role="form" id="form-add-admission-types" action="/ams/app/components/admission-types/store" method="POST">
