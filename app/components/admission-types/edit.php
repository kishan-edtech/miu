...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h6 class="font-weight-bold text-black">Edit <span class="semi-bold">Admission Type</span></h6>
  </div>
  <form role="form" id="form-edit-admission-types" action="/ams/app/components/admission-types/update" method="POST">
