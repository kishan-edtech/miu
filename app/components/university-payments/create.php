...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h6 class="font-wight-bold text-black">Add <span class="semi-bold">Fee Haed</span></h6>
  </div>
  <form role="form" id="form-add-university-payments" action="/ams/app/components/university-payments/store" method="POST">
    <div class="modal-body">
      <div class="row">
        <div class="col-md-12">
          <div class="form-group form-group-default required">
            <label>Fee Head</label>
            <input type="text" name="Fee_Head" class="form-control" placeholder="ex: Exam">
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    $("#form-add-university-payments").on("submit", function(e){
      if($('#form-add-university-payments').valid()){
