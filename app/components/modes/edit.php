...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h6 class="text-black font-weight-bold">Edit <span class="semi-bold">Mode</span></h6>
  </div>
  <form role="form" id="form-edit-modes" action="/ams/app/components/modes/update" method="POST">
