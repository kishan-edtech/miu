...
<div class="modal-header clearfix text-left">
  ...
  <h6 class="font-weight-bold text-bold">Edit <span class="semi-bold">Reason</span></h6>
</div>
<form id="edit_reasons_form" method="POST" action="/ams/app/components/reasons/update">
