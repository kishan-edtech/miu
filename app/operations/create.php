...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold tsxt-black">Add <span class="semi-bold"></span>Operation's User</h5>
</div>
<form role="form" id="form-add-operations" action="/ams/app/operations/store" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  $("#form-add-operations").on("submit", function(e){
    if($('#form-add-operations').valid()){
