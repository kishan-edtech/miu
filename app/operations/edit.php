...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="text-black font-weight-bold">Edit <span class="semi-bold">Operation's User</span></h5>
</div>
<form role="form" id="form-edit-operations" action="/ams/app/operations/update" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  $("#form-edit-operations").on("submit", function(e){
    if($('#form-edit-operations').valid()){
