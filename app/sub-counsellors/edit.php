...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Edit <span class="semi-bold">National Coordinator</span></h5>
</div>
<form role="form" id="form-edit-sub-counsellors" action="/ams/app/sub-counsellors/update" method="POST" enctype="multipart/form-data">
