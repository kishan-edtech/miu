...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Pay Online</h5>
</div>
<form role="form" id="payment-form" action="/ams/app/easebuzz/pay">
  ...
  <div class="modal-footer clearfix text-end">
    ...
    <button aria-label="" type="submit" class="btn btn-primary ">
      <i class="ti ti-circle-check mr-2"></i> Pay</button>
    </div>
  </div>
</form>
