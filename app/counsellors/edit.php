...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Edit <span class="semi-bold">Internal Team</span></h5>
</div>
<form role="form" id="form-edit-counsellors" action="/ams/app/counsellors/update" method="POST" enctype="multipart/form-data">
...
<script>
  $(function() {
    $('#form-edit-counsellors').validate({
      rules: {
        name: {
          required: true
        },
  ...
  $("#form-edit-counsellors").on("submit", function(e) {
    if ($('#form-edit-counsellors').valid()) {
