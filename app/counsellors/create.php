...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Add <span class="semi-bold">Internal Team</span></h5>
</div>
<form role="form" id="form-add-counsellors" action="/ams/app/counsellors/store" method="POST" enctype="multipart/form-data">
...
<script>
  ...
  $("#form-add-counsellors").on("submit", function(e) {
    if ($('#form-add-counsellors').valid()) {
