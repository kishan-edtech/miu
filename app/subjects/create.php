...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Upload Subjects</h5>
</div>
<form role="form" id="form-upload" foemtarget="_blank" action="/ams/app/subjects/store" method="POST" enctype="multipart/form-data">
  <div class="modal-body">
    
    <div class="row">
      <div class="col-md-12 text-end cursor-pointer text-end mb-3  d-flex justify-content-end " onclick="window.open('/ams/app/samples/subjects');">
