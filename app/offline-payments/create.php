...
<div class="modal-header clearfix text-left">
  ...
  <h5 class="font-weight-bold text-black">Add <span class="semi-bold"></span>Offline Payment</h5>
</div>
<form role="form" id="form-add-offline-payments" action="/ams/app/offline-payments/store" method="POST" enctype="multipart/form-data">
