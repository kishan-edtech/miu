...
?>
  ...
  <div class="modal-header clearfix text-left">
    ...
    <h5>Add <span class="semi-bold">Offline Payment</span></h5>
  </div>
  <form role="form" id="form-add-offline-payments" action="/ams/app/offline-payments/store-multiple" method="POST" enctype="multipart/form-data">
