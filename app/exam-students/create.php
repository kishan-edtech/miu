...
<form role="form" id="form-upload" foemtarget="_blank" action="/ams/app/exam-students/store" method="POST" enctype="multipart/form-data">
  <div class="modal-body">
    
    <div class="row">
      <div class="col-md-12 text-end cursor-pointer" onclick="window.open('/app/samples/exam-students');">
