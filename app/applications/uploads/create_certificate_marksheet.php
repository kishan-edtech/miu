...
<div class="modal-header clearfix text-left">
  ...
  <h5>Certificate and Marksheet</h5>
</div>
<form role="form" id="form-upload" foemtarget="_blank" action="/ams/app/applications/uploads/update_certificate_marksheet" method="POST" enctype="multipart/form-data">
  <div class="modal-body">

    <div class="row">
      <div class="col-md-12 text-end cursor-pointer" onclick="window.open('/ams/app/samples/certificate_marksheet');">
