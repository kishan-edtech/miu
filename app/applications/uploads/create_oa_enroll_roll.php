...
<form role="form" id="form-upload" foemtarget="_blank" action="/ams/app/applications/uploads/update_oa_enroll_roll" method="POST" enctype="multipart/form-data">
  <div class="modal-body">
    
    <div class="row">
      <div class="col-md-12 text-end cursor-pointer" onclick="window.open('/ams/app/samples/oa_enroll_roll');">
