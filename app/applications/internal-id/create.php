...
if (isset($_GET['id'])) {
    ...
    $center = $conn->query("SELECT Internal_ID FROM Users WHERE ID = $id");
...
<form role="form" id="form-Internal-id" action="/ams/app/applications/internal-id/store" method="POST">
