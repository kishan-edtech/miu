...
?>
  ...
  <form role="form" id="form-enrollment-no" action="/ams/app/applications/enrollment/store" method="POST">
  ...
  <script type="text/javascript">
    ...
    function generateEnrollmentNo(id) {
      $.ajax({
        url: BASE_URL + '/app/applications/enrollment/generate',
        type: 'POST',
        data: {
          id
        },
        ...
        success: function(data) {
          if (data.status) {
            $("#enrollment_no").val(data.enrollmentNo);
            notification('success', data.message);
          } else {
            notification('danger', data.message);
          }
