...
<div class="modal-header clearfix text-left">
  ...
  <h5>Upload MarkSheet Details</h5>
</div>
<form role="form" id="form-upload" foemtarget="_blank" action="/ams/app/document-issuence/marksheet/store" method="POST" enctype="multipart/form-data">
  <div class="modal-body">
    <div class="row">
      <div class="col-md-12 text-end cursor-pointer" onclick="window.open('/app/samples/marksheet_entry');">
