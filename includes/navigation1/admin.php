  ...
  <div class="sidebar-menu">
    ...
    <ul class="menu-items">
      ...
      <li class="<?php print $breadcrumbs[1] == 'academics' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          <li class="">
            <a href="/academics/verticals">Verticals</a>
      ...
      <li class="<?php print $breadcrumbs[1] == 'admissions' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          ...
          <li class="">
            <a href="/admissions/marksheets">Marksheet</a>
      ...
      <li class="<?php print $breadcrumbs[2] == 'pay-slip' ? 'active' : '' ?>">
        <a href="/accounts/pay-slips">Pay Slip</a>
      ...
      <?php } ?>
            <li class="">
              <a href="/center_authorize/index">Center Authorization Certificate</a>
              <span class="icon-thumbnail"><i class="pg-icon">Co</i></span>
            </li>
     <?php /*
...
<?php } */ ?>
      ...
      <li class="m-t-20 <?php print $breadcrumbs[1] == 'users' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          ...
          <li class="">
            <a href="/users/appliedcenter">Applied Center</a>
            <span class="icon-thumbnail"><i class="pg-icon">AP</i></span>
          </li>
        </ul>
      </li>
      ...
      <?php if (isset($_SESSION['has_lms']) && $_SESSION['has_lms'] == 1) { ?>
        <li class="<?php print $breadcrumbs[1] == 'lms-settings' ? 'open active' : '' ?>">
          ...
          <ul class="sub-menu">
            ...
            <li class="">
              <a href="/lms-settings/notes">Notes</a>
