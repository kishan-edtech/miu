      ...
      ?>
        <li class="<?php print $breadcrumbs[1] == 'accounts' ? 'open active' : '' ?>">
          ...
          <ul class="sub-menu">
            ...
            <?php 
               while ($page = $pages->fetch_assoc()) { 
    if ($page['Name'] !== 'Online Payments' && $page['Name'] !== 'Student Ledgers') {
?>
      <li class="<?php print $breadcrumbs[2] == $page['Slug'] ? 'active' : '' ?>">
        <a href="/ams/accounts/<?= $page['Slug'] ?>"><?= $page['Name'] ?></a>
        <span class="icon-thumbnail">
          <i class="pg-icon"><?= substr(str_replace(array('-', ' '), '', $page['Name']), 0, 2) ?></i>
        </span>
      </li>
<?php 
    } 
      ...
      <li class="m-t-20 <?php print $breadcrumbs[1] == 'users' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          ...
          <li class="">
            ...
            <span class="icon-thumbnail"><i class="pg-icon">RC</i></span>
          </li>
          <li class="">
