  ...
  <div class="sidebar-menu">
    ...
    <ul class="menu-items">
      ...
      <li class="<?php print $breadcrumbs[1] == 'academics' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          <li class="">
            <a href="/ams/academics/verticals">Verticals</a>
            <span class="icon-thumbnail"><i class="pg-icon">Vt</i></span>
          </li>
          <li class="">
            <a href="/ams/academics/departments">Departments</a>
            <span class="icon-thumbnail"><i class="pg-icon">Dp</i></span>
          </li>
          <li class="">
            <a href="/ams/academics/programs">Programs</a>
            <span class="icon-thumbnail"><i class="pg-icon">Co</i></span>
          </li>
          <li class="">
            <a href="/ams/academics/specializations">Specializations</a>
            <span class="icon-thumbnail"><i class="pg-icon">SC</i></span>
          </li>
          <!--<li class="">-->
          <!--  <a href="/ams/academics/syllabus">Syllabus</a>-->
      ...
      <li class="<?php print $breadcrumbs[1] == 'admissions' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          ...
          <li class="">
            <a href="/ams/admissions/marksheets">Marksheet</a>
            <span class="icon-thumbnail"><i class="pg-icon">M</i></span>
          </li>
                    <li class="">
            <a href="/ams/admissions/certificates">Certificate</a>
      ...
      ?>
        <li class="<?php print $breadcrumbs[1] == 'accounts' ? 'open active' : '' ?>">
          ...
          <ul class="sub-menu">
            ...
            <?php } ?>
              <!-- 🔹 Static Pay Slip Page -->
      <li class="<?php print $breadcrumbs[2] == 'pay-slip' ? 'active' : '' ?>">
        <a href="/ams/accounts/pay-slips">Pay Slip</a>
        <span class="icon-thumbnail"><i class="pg-icon">PS</i></span>
      </li>
          </ul>
        </li>
      <?php } ?>
            <li class="">
              <a href="/ams/center_authorize/index">Center Authorization Certificate</a>
              <span class="icon-thumbnail"><i class="pg-icon">Co</i></span>
            </li>
     <?php /*
...
?>
        <li class="<?php print $breadcrumbs[1] == 'downloads' ? 'open active' : '' ?>">
          ...
          <ul class="sub-menu">
            <?php while ($page = $pages->fetch_assoc()) { ?>
              <li class="<?php print $breadcrumbs[2] == $page['Slug'] ? 'active' : '' ?>">
                <a href="/ams/downloads/<?= $page['Slug'] ?>"><?= $page['Name'] ?></a>
                <span class="icon-thumbnail"><i class="pg-icon"><?= substr(str_replace(array('-', ' '), '', $page['Name']), 0, 2) ?></i></span>
              </li>
            <?php } ?>
          </ul>
...
<?php } */ ?>
      ...
      <li class="m-t-20 <?php print $breadcrumbs[1] == 'users' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          <li class="">
            <a href="/ams/users/vertical-heads">Vertical Heads</a>
            <span class="icon-thumbnail"><i class="pg-icon">VH</i></span>
          </li>
          <li class="">
            <a href="/ams/users/academic-heads">Academic Heads</a>
            <span class="icon-thumbnail"><i class="pg-icon">AH</i></span>
          </li>
          <li class="">
            <a href="/ams/users/operations">Operations</a>
            <span class="icon-thumbnail"><i class="pg-icon">Ot</i></span>
          </li>
          <li class="">
            <a href="/ams/users/internal-team">Counsellor</a>
            <span class="icon-thumbnail"><i class="pg-icon">CO</i></span>
          </li>
          <li class="">
            <a href="/ams/users/national-coordinators">Sub-Counsellor</a>
            <span class="icon-thumbnail"><i class="pg-icon">SC</i></span>
          </li>
          <li class="">
            <a href="/ams/users/regional-coordinator-master">Center Master</a>
            <span class="icon-thumbnail"><i class="pg-icon">CM</i></span>
          </li>
          <li class="">
            <a href="/ams/users/regional-coordinators">Center</a>
          ...
          <li class="">
            <a href="/ams/users/accountants">Accountants</a>
            <span class="icon-thumbnail"><i class="pg-icon">AC</i></span>
          </li>
          <li class="">
            <a href="/ams/users/appliedcenter">Applied Center</a>
            <span class="icon-thumbnail"><i class="pg-icon">AP</i></span>
          </li>
        </ul>
      </li>
      ...
      <li class="m-t-20 <?php print $breadcrumbs[1] == 'settings' ? 'open active' : '' ?>">
        ...
        <ul class="sub-menu">
          <li class="">
            <a href="/ams/settings/crm">CRM</a>
            <span class="icon-thumbnail"><i class="pg-icon">Cr</i></span>
          </li>
          <li class="">
            <a href="/ams/settings/admission">Admission</a>
      ...
      <?php if (isset($_SESSION['has_lms']) && $_SESSION['has_lms'] == 1) { ?>
        <li class="<?php print $breadcrumbs[1] == 'lms-settings' ? 'open active' : '' ?>">
          ...
          <ul class="sub-menu">
            ...
            <li class="">
              <a href="/ams/lms-settings/student_assignments_review">Assignments Review</a>
            ...
            <li class="">
              <a href="/ams/lms-settings/notes">Notes</a>
            ...
            <!--</li>-->
            <!--<li class="">-->
            <!--  <a href="/ams/lms-settings/documents">Documents</a>-->
      ...
      <li class="menu-item">
        <!--<a href="/ams/university/payouts" class="menu-link ">-->
          <a href="/ams/university/university-payouts" class="menu-link">
          <i class="menu-icon ri-money-rupee-circle-fill"></i>
          <div data-i18n="University Payment">Universities Payment</div>
        </a>
      </li>
