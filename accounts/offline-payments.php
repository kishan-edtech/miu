          ...
          <div class="inner">
            ...
            <ol class="breadcrumb d-flex flex-wrap justify-content-between align-self-start">
              ...
              <div>
                ...
                <button class="btn btn-link" aria-label="" title="" data-toggle="tooltip" data-original-title="Add Offline Payment" onclick="add('offline-payments', 'lg')"> <i class="ti ti-copy-plus add_btn_form" style="font-size:24px"></i></button>
              </div>
            </ol>
            <!-- END BREADCRUMB -->
          </div>
    ...
    <script type="text/javascript">
      ...
      $(function() {
        ...
        var settings = {
          ...
          'serverMethod': 'post',
          'ajax': {
            'url': BASE_URL + '/app/offline-payments/server'
          },
          'columns': [{
              data: "File",width:"10%",
            ...
            {
              data: "Bank",width: (role === "Sub-Counsellor" || role === "Sub-Center") ? "100%" :"20%" ,
            },
            {
            ...
            },
            {
              data: "ID",width:"10%",
              "render": function(data, type, row) {
                var status_button = (role == 'Accountant' || role == 'Administrator') && row.Status == 0 ? '<i class="ti ti-circle-check add_btn_form h5 mr-2 cursor-pointer" data-toggle="tooltip" data-original-title="Approve" title="" onclick="updatePaymentStatus(&#39;' + data + '&#39, &#39;1&#39;)"></i><i class="ti ti-playstation-x add_btn_form mr-2  h5 cursor-pointer" data-toggle="tooltip" data-original-title="Reject" title="" onclick="updatePaymentStatus(&#39;' + data + '&#39, &#39;2&#39;)"></i>' : '';
                ...
                var action_button = (role == 'Accountant' || role == 'Administrator' || role == 'University Head') && row.Status != 1 ? '<i class="ti ti-trash-x cursor-pointer add_btn_form h5" title="Delete" onclick="destroy(&#39;offline-payments&#39;, &#39;' + data + '&#39)"></i>' : '';
      ...
      function updatePaymentStatus(id, value) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            $.ajax({
              url: BASE_URL + '/app/offline-payments/update-payment-status',
              type: 'POST',
              data: {
                id,
                value
