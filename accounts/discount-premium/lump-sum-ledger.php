  ...
  <div class="page-content-wrapper ">
    ...
    <script>
      ...
      function getStudentList(id) {
        $.ajax({
          url: BASE_URL + '/app/centers/ledgers/lump-sum/students?id=' + id,
          type: 'GET',
      ...
      function getInvoiceList(id) {
        $.ajax({
          url: BASE_URL + '/app/centers/ledgers/lump-sum/invoices?id=' + id,
          type: 'GET',
          success: function(data) {
            $("#invoices").html(data);
          }
      ...
      function getCenterLedger(id) {
        $.ajax({
          url: BASE_URL + '/app/centers/ledgers/lump-sum/ledger?id=' + id,
          type: 'GET',
          success: function(data) {
            $("#ledger").html(data);
          }
      ...
      function showStudents(id) {
        $.ajax({
          url: BASE_URL + '/app/centers/ledgers/lump-sum/list?id=' + id,
          type: 'GET',
          success: function(data) {
