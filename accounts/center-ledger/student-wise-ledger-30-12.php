  ...
  <div class="page-content-wrapper ">
    ...
    <script>
      ...
      function getStudentList(id, admission_session_id) {
        ...
        $.ajax({
          url: BASE_URL + '/app/centers/ledgers/student-wise/students?id=' + id + '&admission_session_id=' + admission_session_id,
          type: 'GET',
      ...
      function getPendingList(id, admission_session_id) {
        $.ajax({
          url: BASE_URL + '/app/centers/ledgers/student-wise/pending?id=' + id + '&admission_session_id=' + admission_session_id,
          type: 'GET',
          success: function(data) {
            $("#pending").html(data);
          }
      ...
      function getProcessedList(id, admission_session_id) {
        $.ajax({
          url: BASE_URL + '/app/centers/ledgers/student-wise/processed?id=' + id + '&admission_session_id=' + admission_session_id,
          type: 'GET',
          success: function(data) {
